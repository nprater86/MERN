...
const RenderStarship = props => {
    return (
        <div>
            ...
            <h3 className="mt-3">Hyperdrive Rating: <span style={{fontWeight: 'normal'}}>{ parseInt(props.data.hyperdrive_rating).toLocaleString('en-US') }</span></h3>
        </div>
    );
}

export default RenderStarship;